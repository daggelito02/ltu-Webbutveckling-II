  ...
  <body>
    ...
    <ul>
      <li>
        ...
        <a href="~dagfre-3/labb-1a/sida1.php">
        Strängar &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-1a/sida2.php">
        Arrayer &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-1a/sida3.php">
        Loopar och villkorssatser &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-1a/sida4.php">
        Funktioner &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-1a/sida5.php">
        Servervariabler &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-1a/sida6.html">
    ...
    <ul>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-2a/login.php">
        login &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-2a/index.php">
        index &raquo;
        </a>
      </li>
    </ul>
    ...
    <ul>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-3a/task_one.html">
          Koduppgift ett &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-3a/task_two.html">
          Koduppgift två &raquo;
        </a>
      </li>
      <li>
        <span class="material-symbols-outlined green">check_box</span>
        <a href="~dagfre-3/labb-3a/task_three.html">
